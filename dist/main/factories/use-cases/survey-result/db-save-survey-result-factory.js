...
const db_save_survey_result_1 = require("@/data/use-cases/survey-result/save-survey-result/db-save-survey-result");
const makeDbSaveSurveyResult = () => {
    ...
    return new db_save_survey_result_1.DbSaveSurveyResult(surveyResultMongoRepository, surveyResultMongoRepository);
};
