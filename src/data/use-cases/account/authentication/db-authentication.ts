import type { Authentication, LoadAccountByEmailRepository, AuthenticationParams, HashComparer, Encrypter, UpdateAcessTokenRepository } from './db-authentication-protocols'
